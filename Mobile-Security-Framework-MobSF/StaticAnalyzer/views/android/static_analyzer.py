...
from StaticAnalyzer.views.android.debug_analysis import debug_analysis
from StaticAnalyzer.views.android.root_analysis import root_analysis
from StaticAnalyzer.views.android.webview_analysis import webview_analysis
...
from StaticAnalyzer.views.android.so_analysis import so_analysis
        ...
        if (
            ...
            if typ == 'apk':
                ...
                if db_entry.exists() and rescan == '0':
                    ...
                    #lty
                    so_list = so_analysis(app_dic['app_dir'])

                    for key in so_list:
                        apkid_results[key] = {'packer': ''}
                    ...
                    debug_an_dic = debug_analysis(
                        app_dic['app_dir'],
                        'apk',
                        app_dic['manifest_file'])
                    root_an_dic = root_analysis(
                        app_dic['app_dir'],
                        'apk',
                        app_dic['manifest_file'])
                    webview_an_dic = webview_analysis(
                        app_dic['app_dir'],
                        'apk',
                        app_dic['manifest_file']
                    )
